                                    ...
                                    <div className="mb-6 lg:mb-0 w-80">
                                        <div className="block rounded-lg">
                                            <div className="relative overflow-hidden bg-no-repeat bg-cover">
                                                <img src={het} className="w-full rounded-t-lg" alt='user avatar' />
                                                <a href="#!">
                                            ...
                                            <div className="p-6">
                                                <h5 className="text-lg font-bold mb-4">Het Patel</h5>
                                                <p className="text-gray-500 mb-4">B.Tech 3rd Year IT Student</p>
                                                <ul className="list-inside flex mx-auto justify-center text-blue-600">
                                                    <a href="https://github.com/patelhettt" className="px-2">
                                                        <BsGithub />
                                                    </a>
                                                    <a href="https://www.linkedin.com/in/hetpatel9" className="px-2">
                                                        <BsLinkedin />
                                                    </a>
                                                    <a href="https://www.facebook.com/AwesomeHet1/" className="px-2">
                                                        <BsFacebook />
                                                    </a>
                                                </ul>
                                            </div>
                            ...
                            <div className="flex flex-wrap items-center">
                                <div className="grow-0 shrink-0 basis-auto block w-full lg:flex lg:w-6/12 xl:w-4/12">
                                    <div className="mb-6 lg:mb-0 w-80">
                                        <div className="block rounded-lg">
                                            <div className="relative overflow-hidden bg-no-repeat bg-cover">
                                                <img src={rahul} className="w-full rounded-t-lg" alt='user avatar' />
                                                <a href="#!">
                                                    <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"></div>
                                                </a>
                                                <svg className="absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
                                            ...
                                            <div className="p-6">
                                                <h5 className="text-lg font-bold mb-4">Rahul Parmar</h5>
                                                <p className="text-gray-500 mb-4">B.Tech 3rd Year IT Student</p>
                                                <ul className="list-inside flex mx-auto justify-center text-blue-600">
                                                    <a href="https://github.com/patelhettt" className="px-2">
                                                        <BsGithub />
                            ...
                            <div className="flex flex-wrap items-center">
                                <div className="grow-0 shrink-0 basis-auto block w-full lg:flex lg:w-6/12 xl:w-4/12">
                                    <div className="mb-6 lg:mb-0 w-80">
                                        <div className="block rounded-lg">
                                            <div className="relative overflow-hidden bg-no-repeat bg-cover">
                                                <img src={sidd} className="w-full rounded-t-lg" alt='user avatar' />
                                                <a href="#!">
                                                    <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"></div>
                                                </a>
                                                <svg className="absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
                                            ...
                                            <div className="p-6">
                                                <h5 className="text-lg font-bold mb-4">Siddhant Rathod</h5>
                                                <p className="text-gray-500 mb-4">B.Tech 3rd Year IT Student</p>
                                                <ul className="list-inside flex mx-auto justify-center text-blue-600">
                                                    <a href="https://github.com/siddhant" className="px-2">
                                                        <BsGithub />
                                                    </a>
                                                    <a href="https://www.linkedin.com/in/siddhant" className="px-2">
                                                        <BsLinkedin />
                                                    </a>
                                                    <a href="https://www.facebook.com/siddhant/" className="px-2">
                                                        <BsFacebook />
                                                    </a>
                                                </ul>
                                            </div>
