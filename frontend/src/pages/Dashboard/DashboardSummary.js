...
const DashboardSummary = () => {
    ...
    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/products/pharmacy')
            .then(res => res.json())
            .then(products => setPharmacyProducts(products.length));
    }, [pharmacyProducts]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/products/nonPharmacy')
            .then(res => res.json())
            .then(products => setNonPharmacyProducts(products.length));
    }, [nonPharmacyProducts]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/requestedItems/pharmacy')
            .then(res => res.json())
            .then(products => setPharmacyRequestedItems(products.length));
    }, [pharmacyRequestedItems]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/requestedItems/nonPharmacy')
            .then(res => res.json())
            .then(products => setNonPharmacyRequestedItems(products.length));
    }, [nonPharmacyRequestedItems]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/orders/pharmacy')
            .then(res => res.json())
            .then(products => setPharmacyOrders(products.length));
    }, [pharmacyOrders]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/orders/nonPharmacy')
            .then(res => res.json())
            .then(products => setNonPharmacyOrders(products.length));
    }, [nonPharmacyOrders]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/purchases/pharmacy')
            .then(res => res.json())
            .then(products => setPharmacyPurchases(products.length));
    }, [pharmacyPurchases]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/purchases/nonPharmacy')
            .then(res => res.json())
            .then(products => setNonPharmacyPurchases(products.length));
    }, [nonPharmacyPurchases]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/returns/customers')
            .then(res => res.json())
            .then(products => setReturnsCustomers(products.length));
    }, [returnsCustomers]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/returns/expiresOrDamages')
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/setup/companies')
            .then(res => res.json())
            .then(products => setCompanies(products.length));
    }, [companies]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/products/employees')
            .then(res => res.json())
            .then(e => setEmployees(e.length));
    }, [employees]);

    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/products/customers')
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch('https://quickmeds-backend-online.onrender.com/api/suppliers/documents')
            .then(res => res.json())
